...
namespace BOTLIB
{
    public class BotUtilityNative
    {
        ...
        public static Bitmap getScreenshotOfWindowRegion(IntPtr windowHandle, Point regionBegin, Point regionEnd)
        {
            ...
            //Width and height of window
            int winWidth = WINDOW.Right - WINDOW.Left;
            int winHeight = WINDOW.Top - WINDOW.Bottom;
            ...
            //screenshot.Save("C:\\Users\\ronda\\Pictures\\test.bmp");
        ...
        public void sendKeysWait(string keys, int delay = 300)
        {
       ...
       public IntPtr GetGameHandle()
        {
            IntPtr Handle = FindWindow(null, "LOST ARK (64-bit, DX11) v.2.0.1.1");
            return Handle;
        }
